...
<body>
   ...
   <div id="pageContainer">
      <div style="padding-top: 25px; text-align: center">
         <form name="bbs" action="${pageContext.request.contextPath}/board_rewriteok.meta?idx=${requestScope.idx}&cp=${requestScope.cpage}&ps=${requestScope.pagesize}" method="POST">
